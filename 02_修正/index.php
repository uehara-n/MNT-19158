<?php get_header(); ?>
<div id="top_content">
	<div id="main_v" class="top_slide_slick">
		
			<div class="item"><a href="<?php bloginfo('url'); ?>/seko"><img src="<?php echo get_template_directory_uri(); ?>/page_image/top/slide/slide1.jpg" alt="外壁屋根塗装　創業69年の歴史" ></a>
			</div>
			<div class="item"><a href="<?php bloginfo('url'); ?>/asecplan/p_re"><img src="<?php echo get_template_directory_uri(); ?>/page_image/top/slide/slide2.jpg" alt="プロタイムズ敦賀店の表彰実績" ></a>
			</div>
			<div class="item"><a href="<?php bloginfo('url'); ?>/asecplan/p_muki"><img src="<?php echo get_template_directory_uri(); ?>/page_image/top/slide/slide3.jpg" alt="プラチナ無機シリーズ" ></a>
			</div>
			<div class="item"><a href="<?php bloginfo('url'); ?>/hyosyo"><img src="<?php echo get_template_directory_uri(); ?>/page_image/top/slide/slide4.jpg" alt="超低汚染プラチナリファイン2000MF" ></a>
			</div>
